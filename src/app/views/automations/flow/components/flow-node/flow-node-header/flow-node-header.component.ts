...
import { lucideMail, lucideClock, lucideCircleHelp, lucideTrash2 } from '@ng-icons/lucide';
...
@Component({
  ...
  providers: [provideIcons({ lucideMail, lucideClock, lucideCircleHelp, lucideTrash2 })]
})
